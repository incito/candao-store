...
public class Parser {
    ...
    static public Document parse(String systemId, Reader reader)
     ...
     */
    static public Document parse(byte[] xml)
        throws ParseException, IOException {
        BuildDocument bd = new BuildDocument();
        new ParseByteStream(
    ...
    static public Document parse(String systemId, InputStream istream)
        throws ParseException, IOException {
        BuildDocument bd = new BuildDocument();
