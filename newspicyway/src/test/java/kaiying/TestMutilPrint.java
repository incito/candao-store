...
//	    object.setPrintnum(2);
	    ...
	    pDish2.setPrintipaddress("192.168.2.115");
	    pDish2.setSperequire("清蒸");
	    pDish2.setTableNomsg("20");
	    pDish2.setDishNum("2");
	    pDish2.setPrintport("9100");
...
//			socket = new Socket("192.168.40.138", 9100);
			...
			for (PrintDish printDish : printDishList) {
				...
				String dishunit2 = StringUtils.bSubstring2(
						printDish.getDishUnit(), 2);
