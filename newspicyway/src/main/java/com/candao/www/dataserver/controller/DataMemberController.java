...
public class DataMemberController {
     ...
     */
    @ResponseBody
    @RequestMapping(value = "/setMemberPrice/{userId}/{orderId}/{ip}/{memberNo}/", produces = {"application/json;charset=UTF-8"})
     ...
     */
    @ResponseBody
    @RequestMapping(value = "/setMemberPrice3/{userId}/{orderId}/{ip}/", produces = {"application/json;charset=UTF-8"})
