...
public class Constant {
  ...
  public static final String PROJECT_UPLOAD_PATH = PROJECT_WEBAPPS_PATH+"upload/";
	...
	public static final String PSIERROR = "{\"result\":\"0\",\"msg\":\"结算成功，进销存调用失败！\"}";
...
//		public  static final int  DISCARD_STATUS = 5;
	...
	public class MessageType {
		...
		public static final String msg_2002 = "2002"; // 清除手环以前的结算推送消息
		...
		public static final String msg_2201 = "2201"; // 订单菜品更新消息推送
