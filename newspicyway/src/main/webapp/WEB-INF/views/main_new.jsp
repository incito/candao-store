				...
				<li  class="ky-dropdown" id="bb">
					<a href="#" class="ky-menu-success ky-menu-report" onclick="toAnalysis()">报表分析</a>
					 <ul class="ky-dropdown-menu ky-nav ky-nav-pills">
						...
						<li><a href="#" class="ky-menu-success" onclick="toSaleRept()">营业数据明细表</a></li>
						<li><a href="#" class="ky-menu-success" onclick="toSettleDetailRept()">结算方式明细表</a></li>
						<li><a href="#" class="ky-menu-success" onclick="toDishSaleRept()">品项销售明细表</a></li>
						<li><a href="#" class="ky-menu-success" onclick="toCouponsRept()">优惠活动明细表</a></li>
...
function bindEventForsecondMenu(id){
	$('#'+id).mouseover(function() {
		...
		var bgcolor = $(this).children('a').css(
				'border-left-color');
