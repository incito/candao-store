...
<link rel="stylesheet" type="text/css" href="<%=request.getContextPath()%>/css/easyui/metro/easyui.css"/>
...
<link rel="stylesheet" href="<%=request.getContextPath()%>/css/xld/xldcommon.css" type="text/css">
...
<script type="text/javascript" src="<%=request.getContextPath()%>/scripts/validatebox.js"></script>
<script type="text/javascript" src="<%=request.getContextPath()%>/scripts/commons.js"></script>
<script type="text/javascript" src="<%=request.getContextPath()%>/scripts/easyuibugs.js"></script>
<script type="text/javascript" src="<%=request.getContextPath()%>/scripts/jqueryUtil.js"></script>
