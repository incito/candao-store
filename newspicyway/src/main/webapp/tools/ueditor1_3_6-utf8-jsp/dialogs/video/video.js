...
(function(){
    ...
    function initUpload(){
        var settings = {
            ...
            file_types:"*.mp4;*.swf;*.wmv;*.flv;*.avi;*.rm;*.rmvb;*.mpeg;*.mpg;*.ogg;*.mov;*.wmv",//允许的扩展名，多个扩展名之间用分号隔开，支持*通配符
//            file_types:".swf", ".wmv", ".flv", ".avi", ".rm", ".rmvb", ".mpeg", ".mpg", ".ogg", ".mov", ".wmv", ".mp4"//允许的扩展名，多个扩展名之间用分号隔开，支持*通配符
            file_types_description:"视频",                      //扩展名描述
            file_upload_limit:1000,                                   //单次可同时上传的文件数目
            file_queue_limit:1000,                                      //队列中可同时上传的文件数目
