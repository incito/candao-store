...
(function () {
     ...
     */
	window.UEDITOR_HOME_URL = '/newspicyway/tools/ueditor1_3_6-utf8-jsp/';
    ...
    window.UEDITOR_CONFIG = {
        ...
        ,compressSide:1                          //等比压缩的基准，确定maxImageSideLength参数的参照对象。0为按照最长边，1为按照宽度，2为按照高度
         ,maxImageSideLength:2800                   //上传图片最大允许的边长，超过会自动等比缩放,不缩放就设置一个比较大的值，更多设置在image.html中
       ...
       //视频上传配置区  URL=/kaiying/tools/ueditor1_3_6-utf8-jsp/
        ,getMovieUrl:URL+"jsp/getMovie.jsp"                   //视频数据获取地址
        ,videoUrl:"/newspicyway/video/upload"               //附件上传提交地址
...
//                      'customstyle', 'paragraph', 'fontfamily', 'fontsize', '|',
//                      'indent', '|','justifyleft', 'justifycenter', 'justifyright', 'justifyjustify',  '|','link',
