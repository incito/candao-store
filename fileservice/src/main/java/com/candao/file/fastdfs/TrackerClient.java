	...
	*/
	public StorageServer getStoreStorage(TrackerServer trackerServer, String groupName) throws IOException
	{
		...
		try
		{
			...
			/** 
			 *  上线产生的bug 没有权限读取 服务器的local name 
			 */
//			InetAddress netaddres  = trackerSocket.getInetAddress();
			
//			System.out.println(netaddres.getHostAddress() +","+netaddres.getLocalHost()+",trackerSocket.getLocalPort()="+trackerSocket.getLocalPort()
//					+",trackerSocket.getPort() ="+trackerSocket.getPort());
