    ...
    <div class="content">
        ...
        <div class="left-div">
            <div class="order-info">
                ...
                <div>
                    桌号：<span class="J-table-no"><%=tableno%></span>&nbsp;&nbsp;&nbsp;&nbsp;人数：<span
                        class="J-person-no"><%=personnum%></span>
                </div>
            </div>
            <div class="dish-sel">
            ...
            <div>
                ...
                <div class="total-amount">
                    <div class="tip" style="float: left;width:100%;margin-top: -8px">
                        <hr class="lf-hr" style="height: 16px">
                        消费：￥<span id="amount">0.00</span></div>
                    <div class="tip" style="float: left;font-size: 14px;">
            ...
            <div class="more-oper hide">
                <ul>
                    ...
                    <li id="serviceCharge" onclick="Order.serviceCharge()">服务费</li>
                </ul>
            </div>
                ...
                <div class="dialog-sm-info">
                    ...
                    <div class="form-group">
                        ...
                        <input type="text"
                               ...
                               autofocus class="form-control J-pref-ipt padding-left">
                    </div>
        ...
        <div class="modal-content">
            ...
            <div class="modal-body">
                ...
                <div class="dialog-sm-info">
                    ...
                    <div class="form-group"><span class="inpt-span">其他退菜原因：</span><input type="text"
                                                                                         id="backfood-reason"
                                                                                         class="form-control padding-left"
                                                                                         onclick="widget.textAreaModal({ target: $(this), note: $(this).val() }).show();">
                    </div>
                </div>
                <div class="btn-operate  ">
...
<div class="modal fade default-dialog in input-num-dialog" id="backfoodnum-dialog"
    ...
    <div class="modal-dialog">
        <div class="modal-content">
            ...
            <div class="modal-body">
                <div class="dialog-sm-info">
                    <div class="form-group dishname" style="font-size: 16px;color: #FF5803;padding-left: 10px;"><span
                            class="dish-name">扇贝</span></div>
                    <div class="form-group">
                ...
                <div class="btn-operate">
                    <button class="btn btn-cancel in-btn135" type="button" onclick="closeConfirm('backfoodnum-dialog')">
                        取消
                    </button>
...
<div class="modal fade in dialog-normal bg-gray" data-backdrop="static" id="backfood-right"
        ...
        <div class="modal-content">
            ...
            <div class="modal-body">
                ...
                <div class="form-group search J-search">
                    <span class="glyphicon glyphicon-search"></span> <input type="search" class="form-control"
                                                                            placeholder="输入首字母">
                        ...
                        <div class=" ">
                            <ul class="member-info-list">
                                ...
                                <li>发票金额：
                                    ...
                                    <input type="text" class="invoiceMoney" autofocus
                                           style='width: 70px;margin:0 5px;padding-left:5px;height: 28px;border: none;'>
...
<!-- 手动服务费 -->
<div class="modal fade default-dialog in " id="MT-serviceCharge"
     data-backdrop="static">
    <div class="modal-dialog">
        <div class="modal-content">
            <div class="dialog-sm-header">
                <div class="modal-title">服务费</div>
                <img src="../images/close-sm.png" class="img-close" data-dismiss="modal">
            </div>
            <div class="modal-body">
                <!-- 仅存在一个分类中-->
                <div class="row">
                    <div class="col-md-6">
                        <div class=" ">
                            <ul class="member-info-list">
                                <li>
                                    <label>服务费：</label>
                                    <span class="serviceCharge-Switch select" chargeOn="1">收费</span>
                                    <span class="serviceCharge-Switch" chargeOn="0"> 免费</span>
                                </li>
                                <li><label>当前服务费：</label><span class="Auto-serviceCharge" style="margin: 0 10px"></span></li>
                                <li><label>实收服务费：</label>
                                    <input type="text" class="MT-serviceCharge" autofocus
                                           style='width: 110px;margin:0 5px;padding-left:5px;height: 28px;border:1px solid #fff;' >
                                </li>
                            </ul>
                        </div>
                    </div>
                    <div class="col-md-6">
                        ...
                        <div class="form-group form-group-base ya_btn" style="margin-top: 10px">
                            ...
                            <button class="btn-default btn-lg btn-base btn-base-flex2  " id="serviceCharge-btnOk">确定
                            </button>
                        </div>
                    </div>
                </div>
...
<%--手动服务费权限验证--%>
<div class="modal fade in dialog-normal bg-gray" data-backdrop="static" id="serviceCharge-dialog"
     style="overflow: auto;"></div>
